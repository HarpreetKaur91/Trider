      ...
      <ul class="nav">
            ...
            <li class="nav-item">
                <a class="nav-link" data-bs-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
                    <span class="menu-title">Providers</span><i class="menu-arrow"></i>
                </a>
                <div class="collapse" id="ui-basic" style="visibility: visible !important;">
                    <ul class="nav flex-column sub-menu">
                        <li class="nav-item"> <a class="nav-link" href="{{ route('employee') }}">Employee</a></li>
                        <li class="nav-item"> <a class="nav-link" href="{{ route('freelancer') }}">Freelancer</a></li>
                    </ul>
                </div>
            </li>
            <li class="nav-item">
