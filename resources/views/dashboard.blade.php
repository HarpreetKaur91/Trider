    ...
    <div class="row">
        ...
        <div class="col-md-4 stretch-card grid-margin">
            <div class="card bg-gradient-info card-img-holder text-white">
                <div class="card-body">
                    <img src="{{asset('assets/images/dashboard/circle.svg')}}" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Total Customers<i class="bi bi-person-check-fill mdi-24px float-right"></i></h4>
        ...
        <div class="col-md-4 stretch-card grid-margin">
            <div class="card bg-gradient-success card-img-holder text-white">
                <div class="card-body">
                    <img src="{{asset('assets/images/dashboard/circle.svg')}}" class="card-img-absolute" alt="circle-image" />
                    <h4 class="font-weight-normal mb-3">Total Providers <i class="bi bi-people-fill mdi-24px float-right"></i></h4>
                    <h2 class="mb-5">{{$data['total_providers']}}</h2>
                    <h6 class="card-text cursor-pointer" onclick="window.location.href='{{route('provider')}}'">View All</h6>
                </div>
            </div>
        </div>
    </div>
