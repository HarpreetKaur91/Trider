        ...
        <div class="col-md-4 stretch-card grid-margin">
            <div class="card bg-gradient-primary card-img-holder text-white">
                <div class="card-body">
                    ...
                    <h6 class="card-text cursor-pointer" onclick="window.location.href='{{route('company')}}'">View All</h6>
                </div>
            </div>
        </div>
        <div class="col-md-4 stretch-card grid-margin">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-capitalize">{{$provider->name}}</td>
